...
# Configuration
REPO_OWNER = "birdtwelve"
REPO_NAME = "cdn"
BRANCH = "main"
BASE_PATH = os.path.abspath("streams")
FINAL_M3U_FILE = os.path.abspath("streams/mystreams.m3u")
PROCESSED_LINKS_FILE = os.path.abspath("streams/processed_links.json")
...
DEFAULT_LOGO = f"https://raw.githubusercontent.com/bugsfreeweb/LiveTVCollector/{BRANCH}/BugsfreeLogo/default-logo.png"
...
def main():
    ...
    for url, (extinf, original_url, variants, channel_name) in unique_streams.items():
        github_url = f"https://birdtwelve.github.io/{REPO_NAME}/streams/{channel_name}.m3u8"
